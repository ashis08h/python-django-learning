...
if internet_gateways:
    ...
    print(f"Internet Gateway '{ig_name}' with Id '{ig_id}' has been created and attached to VPC '{vpc_name}'.")
...
print(f"Subnet_1_ID = '{subnet_1['Subnet']['SubnetId']}', Subnet_2_ID = '{subnet_2['Subnet']['SubnetId']}', Subnet_3_ID = '{subnet_3['Subnet']['SubnetId']}'")