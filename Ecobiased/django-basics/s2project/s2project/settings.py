"""
Django settings for s2project project.
...
SECRET_KEY = 'django-insecure-g(b#)&f!he2#w7d&3(fj!0!i(j3&i*ew(844nqkm^kf^&6!r!b'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                's1app.context_processor.custom_template'
            ],
        },
    },
]
