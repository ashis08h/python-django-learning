# exapmple of bubble sort


def bubble_sort(input_list):

    length_of_bubble_sort = len(input_list)
    for index in range(length_of_bubble_sort):
        for iter in range(length_of_bubble_sort - index - 1):
...
def selection_sort(input_list):
    ...
    for index in range(length_of_input_list):
        min_index = index
        for iter in range(index + 1, length_of_input_list):
...
def insertion_sort(input_list):
    ...
    length_of_input_list = len(input_list)
    for iter in range(1, length_of_input_list):
        key = input_list[iter]
        num = iter - 1
