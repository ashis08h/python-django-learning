class Computer:
    ...
    def __str__(self):
        return f"My computer brand is {self.brand}, cpu is {self.cpu} and graphics is {self.graphics_card}"
...
c1 = bc.add_cpu('cpu1').build()
print(c1)
c2 = bc.add_cpu('cpu2').add_graphics_card('graphics2').build()
print(c2)
